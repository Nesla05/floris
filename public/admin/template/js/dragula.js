(function ($) {
  ...
  dragula([
    ...
    if (iconTochange.hasClass("typcn-tick")) {
      iconTochange
        .removeClass("typcn-tick text-primary")
        .addClass("typcn-input-checked text-success");
    } else if (iconTochange.hasClass("typcn-input-checked")) {
      iconTochange
        .removeClass("typcn-input-checked text-success")
        .addClass("typcn-tick text-primary");
    }
  });
})(jQuery);
