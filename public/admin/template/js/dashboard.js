(function ($) {
  ...
  $(function () {
    ...
    if ($("#transactions-chart").length) {
      var transactionsChartCanvas = $("#transactions-chart")
        .get(0)
        .getContext("2d");

      var gradientFill = transactionsChartCanvas.createLinearGradient(
        0,
        0,
        0,
        110,
    ...
    if ($("#transactions-chart-dark").length) {
      var transactionsChartCanvas = $("#transactions-chart-dark")
        .get(0)
        .getContext("2d");
    ...
    if ($("#sales-chart-a-dark").length) {
      var areaData = {
        ...
        datasets: [
          ...
          {
            data: [73, 70, 82, 70, 90, 97, 71, 98, 88, 98],
            backgroundColor: ["rgba(207, 220, 237, .8)"],
            borderColor: ["rgba(207, 220, 237, .8)"],
            borderWidth: 1,
            fill: "origin",
            label: "Revenue",
          },
    ...
    if ($("#sales-chart-b-dark").length) {
      var salesChartBChartCanvas = $("#sales-chart-b-dark")
        .get(0)
        .getContext("2d");
      var salesChartBChart = new Chart(salesChartBChartCanvas, {
        type: "bar",
    ...
    if ($("#desktop-chart").length) {
      var areaData = {
        ...
        datasets: [
          {
            data: [24, 26, 50],
            backgroundColor: ["#e6b8ff", "#d077ff", "#a43cda"],
      ...
      var areaOptions = {
        ...
        legendCallback: function (chart) {
          ...
          text.push(
            '<div class="mr-2" style="width: 10px; height: 10px; border-radius: 50%;  background: ' +
      ...
      document.getElementById("desktop-chart-legend").innerHTML =
        desktopChart.generateLegend();
    }
    // desktop-chart end
    ...
    if ($("#income-chart").length) {
      ...
      var options = {
        ...
        legendCallback: function (chart) {
          ...
          text.push(
            '<div class="mr-2" style="width: 12px; border-radius: 50%; height: 12px; background-color: ' +
    ...
    if ($("#income-chart-dark").length) {
      ...
      document.getElementById("income-chart-dark-legend").innerHTML =
        incomeChart.generateLegend();
    }
          ...
          datasets: [
            {
              label: "Profit",
              data: [
                35, 38, 29, 35, 37, 38, 24, 28, 19, 33, 42, 48, 33, 33, 29, 27,
                29, 38, 31, 28, 23, 24,
              ],
              backgroundColor: "#a43cda",
            },
