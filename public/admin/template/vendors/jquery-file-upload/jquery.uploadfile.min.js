        ...
        u.change(function () {
          ...
          if (
            ...
            for (var w = '', g = 0; g < i.length; g++)
              (w += o.showFileCounter
                ? t.fileCounter + o.fileCounterStyle + i[g] + '<br>'
                : i[g] + '<br>'),
                t.fileCounter++;
            if (
              -1 != o.maxFileCount &&
      ...
      function f(a, t) {
        return (
          ...
          (this.download = e('<div>' + t.downloadStr + '</div>')
            .appendTo(this.statusbar)
            .hide()),
          (this.del = e('<div>' + t.deletelStr + '</div>')
            .appendTo(this.statusbar)
            .hide()),
